...
DELETE FROM canais WHERE id_canal = 4;
SELECT * FROM canais;
SELECT * FROM videos;
...
JOIN canais AS c ON vc.fk_canal = c.id_canal;
SELECT v.nome_video, v.autor_video, c.nome_canal FROM videos_canais AS vc INNER JOIN videos AS v ON vc.fk_video = v.id_video
